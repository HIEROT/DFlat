...
listLibraryNames = [
    ...
    "Nanocylinders_U540nm_H750nm",
    "Nanocylinders_U650nm_H800nm",
]
...
class Nanocylinders_U540nm_H750nm(Nanocylinders_U180nm_H600nm):
    def __init__(self):
        super().__init__()
        __rawPath = get_path_to_data("data_Nanocylinders_Unit540nm_Height750nm_EngineFDTD.mat")
        data = scipy.io.loadmat(__rawPath)
        ...
        # These are the min-max for the FDTD gridsweep
        self.__param1Limits = [70e-9, 270e-9]
        self.__param2Limits = [1530e-9, 1565e-9]

class Nanocylinders_U650nm_H800nm(Nanocylinders_U180nm_H600nm):
    def __init__(self):
        super().__init__()
        __rawPath = get_path_to_data("data_Nanocylinders_Unit650nm_Height800nm_EngineFDTD.mat")
        data = scipy.io.loadmat(__rawPath)
        ...
        # These are the min-max for the FDTD gridsweep
        self.__param1Limits = [80e-9, 325e-9]
        self.__param2Limits = [1530e-9, 1565e-9]
