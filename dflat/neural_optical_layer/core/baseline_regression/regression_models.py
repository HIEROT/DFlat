...
from dflat.neural_optical_layer.core.models_DNN import MLP_Nanofins_U350_H600, MLP_Nanocylinders_U180_H600, \
    MLP_Nanocylinders_U540_H750
...
class multipoly_my_nanocylinders_12(
    multivariate_polynomial_regression_sklearn,
    MLP_Nanocylinders_U540_H750,
):
    def __init__(self, **kwargs):
            MLP_Nanocylinders_U540_H750.__init__(self)
            multivariate_polynomial_regression_sklearn.__init__(self)

            self.set_model_name("multipoly_my_nanocylinders_12")
            self.set_modelSavePath(
                "fitted_regression_models/multipoly_my_nanocylinders_12/"
            )
