...
class MLP_Nanocylinders_U540_H750(MLP_Object):
    def __init__(self, dtype=tf.float64):
        super(MLP_Nanocylinders_U540_H750, self).__init__()
        ...
        # do not want the computational/memory cost of loading the library when model is
        # used for inference only!
        __param1Limits = [70e-9, 270e-9]  # corresponds to radius m of cylinder for data
        __param2Limits = [1530e-9, 1565e-9]  # corresponds to wavelength m for training data
    ...
    def returnLibraryAsTrainingData(self):
        # FDTD generated data loaded from library class file
        useLibrary = library.Nanocylinders_U540nm_H750nm()
        params = useLibrary.params
        phase = useLibrary.phase
        transmission = useLibrary.transmission
